     ...
     (cefitiStore.empty ? (
        <View>
          <Text style={styles.title} >
            Exigências Fitossanitárias para o trânsito de {cefitiStore.dados.prod} de
            {cefitiStore.dados.hospVul} {cefitiStore.dados.hospSci} do {cefitiStore.dados.orig} para {cefitiStore.dados.dest}
          </Text>
